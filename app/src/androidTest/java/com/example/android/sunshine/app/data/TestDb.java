...
public class TestDb extends AndroidTestCase {
    ...
    /*
        ...
        where you can uncomment out the "createNorthPoleLocationValues" function.
    */
    ...
    public void testWeatherTable() {
        // First insert the location, then use the locationRowId to insert the weather.
    ...
    public long insertLocation() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the query)
